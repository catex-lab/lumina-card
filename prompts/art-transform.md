...
3. 用户完全没提且无明显暗示 → **主动询问一次**：「想要哪种艺术风格？油画 / 水彩 / 水墨 / 素描 / 插画 / 复古（默认水彩）」，给建议不编造。
...
- **ink（水墨）**：`turn into Chinese ink wash painting (shuimo), rice paper texture, fluid ink gradients, generous negative space, elegant minimal, preserve subject exactly`
